...
const App = () => {
  ...
  useEffect(() => {
    const CURRENT_KEY = 'gps_locations_v6.4.9';
    const OLD_KEY = 'gps_locations_v6.4.8';
  ...
  useEffect(() => {
    localStorage.setItem('gps_locations_v6.4.9', JSON.stringify(locations));
  }, [locations]);

  const handleFinishOnboarding = () => {
    localStorage.setItem('onboarding_v6.4.9_done', 'true');
