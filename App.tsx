...
const App = () => {
  ...
  useEffect(() => {
    const CURRENT_KEY = 'gps_locations_v6.4.4';
    const OLD_KEY = 'gps_locations_v6.4.3';
  ...
  useEffect(() => {
    localStorage.setItem('gps_locations_v6.4.4', JSON.stringify(locations));
  }, [locations]);

  const handleFinishOnboarding = () => {
    localStorage.setItem('onboarding_v6.4.4_done', 'true');
