...
const App = () => {
  ...
  useEffect(() => {
    const CURRENT_KEY = 'gps_locations_v6.4.5';
    const OLD_KEY = 'gps_locations_v6.4.4';
  ...
  useEffect(() => {
    localStorage.setItem('gps_locations_v6.4.5', JSON.stringify(locations));
  }, [locations]);

  const handleFinishOnboarding = () => {
    localStorage.setItem('onboarding_v6.4.5_done', 'true');
