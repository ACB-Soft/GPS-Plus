...
<body>
  <div class='container'>
    ...
    <ul>
      <li><span class="bold">1. Aritmetik Ortalama:</span> Veri kümesindeki düşük hassasiyetli veriler elendikten sonra, kalan verilerin basit aritmetik ortalaması hesaplanır. Bu yöntem, örneklem kümesinin genel merkezini belirlemek için kullanılan temel istatistiksel yaklaşımdır.</li>
